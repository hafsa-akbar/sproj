...
namespace sproj.Data.Migrations
{
    ...
    [Migration("20241113024833_InitialMigration")]
            ...
            modelBuilder.Entity("sproj.Data.UserPreferences", b =>
                {
                    ...
                    b.PrimitiveCollection<JobCategory[]>("JobCategories")
                        .HasColumnType("job_category[]");

                    b.PrimitiveCollection<JobExperience[]>("JobExperiences")
                        .HasColumnType("job_experience[]");

                    b.Property<Locale?>("JobLocale")
                        .HasColumnType("locale");

                    b.PrimitiveCollection<JobType[]>("JobTypes")
                        .HasColumnType("job_type[]");
